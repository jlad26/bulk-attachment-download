...
You can also choose to encrypt and password-protect the zip files. However please note that in most cases the standard Windows zip facility will not be able to open the files - you will need to use something like 7-Zip instead.
